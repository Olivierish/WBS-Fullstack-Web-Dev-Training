...
<title>Cocktails Blog <?php pageTitle() ?> - Tag 14 </title>
</head>
<body class="bg-body">
            ...
            <a href="index.php" class="navbar-brand">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item  px-2"><a href="index.php?page=entries"  class="nav-link  color-1 <?= ($page === 'entries') ? 'active fw-bold' : ''  ?>">Posts</a></li>
