...
<nav class="navbar navbar-light navbar-expand-lg">
            <a href="index.php" class="navbar-brand">
                    <img src="images/design/cocktail3.png" alt="logo" title="Home"/>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item  px-2"><a href="index.php?page=cocktails"  class="nav-link  color-1 <?= ($page === 'cocktails') ? 'active fw-bold' : ''  ?>">Cocktails</a></li>
                        <li class="nav-item  px-2"><a href="index.php?page=login"  class="nav-link  color-1 <?= ($page === 'login') ? 'active fw-bold' : ''  ?>">Login</a></li>
